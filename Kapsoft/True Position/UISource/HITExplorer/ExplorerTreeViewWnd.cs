...
namespace HITExplorer
{
    class ExplorerTreeViewWnd : TreeView
    {
        protected override void OnBeforeExpand(TreeViewCancelEventArgs e)
        {
            ...
            ArrayList arrSub = shNode.GetTestFiles();
            // Now do special case of Test files
            ...
            ArrayList arrSub2= shNode.GetSubFolders();
            foreach (ShellItem shChild in arrSub2)
            {
                TreeNode tvwChild = new TreeNode();
                tvwChild.Text = shChild.DisplayName;
                tvwChild.ImageIndex = shChild.IconIndex;
