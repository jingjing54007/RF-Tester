...
namespace HITUI
{
    ...
    // delegate for status
    public delegate object GetValue(Step step);

    public class StepWrapper : DisplayWrapper<Step>
    {
        GetValue GetStatus = null;

        public StepWrapper(List<Step> list) : base(list) { }
        public StepWrapper(List<Step> list, GetValue getStatus)
            : base(list)
        {
            GetStatus = getStatus;
        }
            ...
            get
            {
                if (PropDescriptors == null)
                {
                    ...
                    props.Add(new DynamicPropertyDescriptor(typeof(Step),
                                                            ...
                                                            {
                                                                ((Step)s).Description = (string)value;
                                                            }
                                                            ));
                    ...
                    props.Add(new DynamicPropertyDescriptor(typeof(Step),
                                                            ...
                                                            delegate(object s)
                                                            {
                                                                return ((Step)s).CompleteOnTimeout;
                                                            },
                                                            delegate(object s, object value)
                                                            {
                                                                ((Step)s).CompleteOnTimeout = Convert.ToBoolean(value);
                                                            }));
